...
class HousesTest < ApplicationSystemTestCase
  ...
  test "creating a House" do
    ...
    fill_in "House Owner", with: @house.house_owner
    fill_in "House Status", with: @house.house_status
    fill_in "Province", with: @house.province
    fill_in "Renting Price", with: @house.renting_price
