...
class ContractsTest < ApplicationSystemTestCase
  ...
  test "creating a Contract" do
    ...
    fill_in "Contract Date End", with: @contract.contract_date_end
    fill_in "Contract Date Start", with: @contract.contract_date_start
    fill_in "Contract Status", with: @contract.contract_status
    fill_in "House", with: @contract.house_id
